...
Three visual treatments live on separate branches, sharing the same content
and information architecture:

- `v1.0.0-editorial` — warm, editorial, serif-led (Fraunces / Inter).
- `v1.0.0-technical` — dark, technical, monospace-accented (Inter / IBM Plex Mono).
- `v1.0.0-architectural` — drafting paper, navy ink, dimension-line section markers
